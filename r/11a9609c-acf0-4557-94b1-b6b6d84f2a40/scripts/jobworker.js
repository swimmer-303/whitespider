...
function OnDispatchWorkerMessage(e) {
  ...
  let a;
  self.activeJobId = r;
  if (self.JobHandlers.hasOwnProperty(s)) {
    try {
    ...
    if (a && a.then)
      a.then((e) => SendResult(o, e)).catch((e) => SendError(o, "Rejection in job handler: " + e));
    else SendResult(o, a);
...
const self = {
  ...
  sentBuffers: new Map(),
  JobHandlers: {},
  JobHandlers.ProcessImageData = function (e) {
    const t = e.buffer,
      s = new Uint8Array(t),
      r = e.width,
      o = e.height;
