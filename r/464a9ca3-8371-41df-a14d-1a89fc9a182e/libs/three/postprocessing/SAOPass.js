...
THREE.SAOPass = function ( scene, camera, depthTexture, useNormals, resolution ) {
  ...
  this.supportsDepthTextureExtension =
    depthTexture !== undefined
      ? depthTexture
      : THREE.WebGLRenderer.extensions.get( 'WEBGL_depth_texture' );
  this.supportsNormalTexture =
    useNormals !== undefined ? useNormals : THREE.WebGLRenderer.extensions.get( 'OES_standard_derivatives' );
  ...
  this.hBlurMaterial.defines[ 'HORIZONTAL' ] = 1;
...
const configureBlurMaterial = (material, numSamples, stdDev) => {
  material.defines[ 'NUM_SAMPLES' ] = numSamples;
  material.defines[ 'STDDEV' ] = stdDev;
  material.uniforms[ 'samples' ].value = new Float32Array( numSamples * 2 );
  material.uniforms[ 'stdDev' ].value = stdDev;
...
THREE.SAOPass.prototype = Object.assign(
  Object.create( THREE.Pass.prototype ),
  {
    ...
    render: function ( renderer, writeBuffer, readBuffer/*, deltaTime, maskActive*/ ) {
      ...
      configureBlurMaterial(this.vBlurMaterial, this.params.saoBlurRadius, this.params.saoBlurStdDev);
      configureBlurMaterial(this.hBlurMaterial, this.params.saoBlurRadius, this.params.saoBlurStdDev);
